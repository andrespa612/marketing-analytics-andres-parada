...
# Agregamos un textbox en nuestra pagina web
st.write("Primera prueba de uso de streamlit y ambiente de MA2026")

# El slider de streamlit me permite ingresar por un slider el parametro de inversion
...
# En sreamlit, tenemos un boton que dice Predecir y al dar click activara las lineas de codigo del if
